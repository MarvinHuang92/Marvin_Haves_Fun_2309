...
pygame.display.set_caption("Peter's First Game")
...
# 创建精灵- 人
man = MySprite(screen)
man.load("Man.png", 143, 121, 7)
man.position = (100, 317)

man2 = MySprite(screen)
man2.load("Man2.png", 142, 121, 1)
man2.position = (100, 317)
