...
while True:
    ...
    target = (int(pos_x+hour_x), int(pos_y+hour_y))
    pygame.draw.line(screen, pink, (pos_x,pos_y), target, 26)
    ...
    target = (int(pos_x+min_x), int(pos_y+min_y))
    ...
    target = (int(pos_x+sec_x), int(pos_y+sec_y))
    pygame.draw.line(screen, yellow, (pos_x,pos_y), target, 6)

    #cover the center
    pygame.draw.circle(screen, white, (pos_x,pos_y), 20)

    print_text(font, 0, 0, str(year) + "-" + str(month) + "-" + str(day))
    print_text(font, 0, 24, am_pm + str(hours) + ":" + str(minutes) + ":" + str(seconds))
