...
if exist "%HISTORY_FILE%" (
	...
	rem Expect 3 values in history: PY_PATH, INPUT_DIR, ATTCH_DIR
	if defined LINE3 (
		set "DEF_PY=!LINE1!"
...
set command=%PY_PATH% scripts\package_restore_folder.py package %input_dir% %attch_dir%
echo.
